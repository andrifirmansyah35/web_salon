...
@section('content')
    ...
    <div class="col-md-8">
        <form method="post" action="/layanan/{{ $layanan->slug }}">
            @method('put')
            @csrf
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug"
                    readonly value="{{ old('slug', $layanan->slug) }}">
                @error('slug')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control @error('slug') is-invalid @enderror" id="harga" name="harga"
                    value="{{ old('harga', $layanan->harga) }}" min="1000">
                @error('harga')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="input_kategori" name="kategori_layanan_id">
                    @foreach ($kategori_layanan_all as $kl)
                        @if ($layanan->kategori_layanan_id == $kl->id)
            ...
            <div class="from-group mb-3">
                ...
                @enderror
                <input type="hidden" id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $layanan->deskripsi) }}">
