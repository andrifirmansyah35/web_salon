                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlah_reservasi_hari_ini }}
                                    </div>
                                </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Total Booking reservasi bulan ini</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlah_reservsi_booking_bulan_ini }}
                            </div>
                        </div>
                        <div class="col-auto">
